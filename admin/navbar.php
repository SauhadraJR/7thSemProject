...
<nav id="sidebar" class='mx-lt-5 bg-dark' >
		...
		<div class="sidebar-list">
				<li class="nav-item"><a class="nav-item nav-home" href="index.php?page=home">Home Page</a></li>
				<a href="../index.php?page=home" class="nav-item nav-categories"><span class='icon-field'><i class="fa fa-home"></i></span> Home</a>
