				...
				<div class="card">
					...
					<div class="card-body">
						<table class="table table-condensed table-bordered table-hover">
							...
							<tbody>
								<?php
								$sessionUserId = $_SESSION['login_id'];
								$i = 1;
								$cat = array();
								$cat[] = '';
								...
								if ($_SESSION['login_name'] == 'Administrator') {
									...
									$books = $conn->query("SELECT b.*, u.name as uname, p.name, p.bid_end_datetime as bdt
									FROM bids b
										...
										<td class="text-center">
											<?php if ($row['status'] == 1) : ?>
												...
												<?php else : ?>
													...
													<?php else : ?>
														<span class="badge badge-secondary">Lose in Bidding</span>
													<?php endif; ?>
												<?php endif; ?>
